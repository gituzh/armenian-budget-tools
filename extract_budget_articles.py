...
import colorlog
from budget import flatten_budget_excel_2019_2024
        ...
        if not in_subprogram_block:
            ...
            if col0 and is_numeric(col0) and is_numeric(col3):
                try:
                    ...
                    logger.warning(
                        "Skipping program row due to invalid program code"
                    )
                    continue
        ...
        if in_subprogram_block:
            ...
            if col1 and is_numeric(col1) and is_numeric(col3):
                try:
                    ...
                    logger.warning(
                        "Skipping subprogram row due to invalid subprogram code"
                    )
                    continue
